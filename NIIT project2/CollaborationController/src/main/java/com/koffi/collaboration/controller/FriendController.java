...
public class FriendController {
	...
	@GetMapping("/sendRequest-{username}") //DONE
	public ResponseEntity<Friend> addFriend(@PathVariable("username") String friendID)
	{
		...
		if(check)
		{
			...
			friend.setUserID(httpSession.getAttribute("username").toString());
	...
	@GetMapping("/rejectFriend-{username}")
	public ResponseEntity<Friend> rejectFriend(@PathVariable("username") String friendID)
	{
		friend = new Friend();
		if(httpSession.getAttribute("username")==null)
		{
	...
	public ResponseEntity<Friend> cancelRequest(@PathVariable("username") String friendID)
	{
		friend = new Friend();
		if(httpSession.getAttribute("username")==null)
		{
	...
	public ResponseEntity<Friend> removeFriend(@PathVariable("username") String friendID)
	{
