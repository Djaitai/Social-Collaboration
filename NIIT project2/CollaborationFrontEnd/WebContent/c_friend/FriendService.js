app.factory('FriendService', function($http, $q) {
	...
	return {
		...
		rejectRequest : function(userID) {
			...
			return $http.get(BASE_URL + "rejectFriend-" + userID).then(
					function(response) {
						return response.data;
					}, function(errResponse) {
						console.log("Error Adding Friend");
		...
		removeFriend : function(friendID) {
			...
			return $http.get(BASE_URL + "removeFriend-" + friendID).then(
					function(response) {
						return response.data;
					}, function(errResponse) {
		...
		cancelRequest : function(friendID) {
			...
			return $http.get(BASE_URL + "cancelRequest-" + friendID).then(
					function(response) {
						return response.data;
					}, function(errResponse) {
